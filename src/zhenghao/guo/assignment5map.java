...
public class assignment5map{
   public assignment5map(String title,String latitude, String longitude,int zoom, int width, int height, int scale, String type, String mark) {
